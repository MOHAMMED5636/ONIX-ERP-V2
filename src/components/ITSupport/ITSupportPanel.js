...
const ITSupportPanel = ({ isOpen, onClose }) => {
  // Form state
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      {/* Slide-out Panel */}
      <div className="fixed right-0 top-0 h-full w-full max-w-4xl bg-white shadow-2xl transform transition-transform duration-300 ease-in-out">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">Submit and track IT tickets</p>
                </div>
              </div>
              <button
                onClick={onClose}
                  ...
                  <div>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-gray-400 transition-colors">
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-500">PNG, JPG, PDF, TXT, LOG</span>
                      </label>
                    </div>
