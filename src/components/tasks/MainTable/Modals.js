...
import { XMarkIcon, StarIcon, LinkIcon, PaperClipIcon } from "@heroicons/react/24/outline";
import { format } from 'date-fns';
import { statusColors } from '../utils/tableUtils';

const NewTaskModal = ({ showNewTask, handleCreateTask, onClose }) => {
...
const ProjectSummaryModal = ({ selectedProjectForSummary, onClose }) => {
...
const RatingPromptModal = ({ showRatingPrompt, onClose }) => {
...
const ProjectDialogModal = ({ showProjectDialog, selectedProject, onClose }) => {
