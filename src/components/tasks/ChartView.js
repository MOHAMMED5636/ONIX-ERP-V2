    ...
    <div className="p-6">
      ...
      <div className="mb-8">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-6 text-white shadow-lg">
          <h2 className="text-3xl font-bold mb-2">Construction Analytics</h2>
          <p className="text-indigo-100 text-lg">Jira-style charts and insights for project management</p>
        </div>
      </div>
