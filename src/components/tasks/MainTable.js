                                  ...
                                  <td colSpan={columnOrder.length} className="px-4 py-3">
                                    {showSubtaskForm === task.id ? (
                                      ...
                                      >
                                              ...
                                              {col.key === "category" ? (
                                                ...
                                                <div className="flex items-center gap-2">
                                                  <input
                                                    ...
                                                    placeholder="Enter location or pick on map"
                                                  />
                                                  <button type="button" onClick={() => handleOpenMapPicker('subtask', task.id, newSubtask.id, newSubtask.location)} title="Pick on map" className="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 transition-all duration-200">
                                                    <MapPinIcon className="w-5 h-5 text-blue-500 hover:text-blue-700" />
                                                  </button>
                                                </div>
                                              ) : col.key === "plotNumber" ? (
                                                <input
                                                  className="border border-gray-300 rounded-lg px-3 py-2 text-sm w-full focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-all duration-200"
                                                  value={newSubtask.plotNumber || ""}
                                                  onChange={e => setNewSubtask(nt => ({ ...nt, plotNumber: e.target.value }))}
                                                  placeholder="Enter plot number"
                                                />
                                              ) : col.key === "community" ? (
                                                <input
                                                  className="border border-gray-300 rounded-lg px-3 py-2 text-sm w-full focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-all duration-200"
                                                  value={newSubtask.community || ""}
                                                  onChange={e => setNewSubtask(nt => ({ ...nt, community: e.target.value }))}
                                                  placeholder="Enter community"
                                                />
                                              ) : col.key === "projectType" ? (
                                                <select
                                                  className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-all duration-200 w-full"
                                                  value={newSubtask.projectType || "Residential"}
                                                  onChange={e => setNewSubtask(nt => ({ ...nt, projectType: e.target.value }))}
                                                >
                                                  <option value="Residential">Residential</option>
                                                  <option value="Commercial">Commercial</option>
                                                  <option value="Industrial">Industrial</option>
                                                ...
                                                <input
                                                  className="border border-gray-300 rounded-lg px-3 py-2 text-sm w-full focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-all duration-200"
                                                  value={newSubtask.developerProject || ""}
                                                  onChange={e => setNewSubtask(nt => ({ ...nt, developerProject: e.target.value }))}
                                                  placeholder="Enter developer project"
                                                />
                                              ) : col.key === "notes" ? (
                                                <input
                                                ...
                                                <span className="text-gray-600 font-medium">{newSubtask.autoNumber}</span>
                                              ) : col.key === "predecessors" ? (
                                                <input
                                                  className="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-200 focus:border-blue-400 transition-all duration-200 w-full"
                                                  value={newSubtask.predecessors || ""}
                                                  onChange={e => setNewSubtask(nt => ({ ...nt, predecessors: e.target.value }))}
                                                  placeholder="Enter predecessors"
                                                />
                                              ) : null}
                                            </div>
                                        ...
                                        <div className="flex items-center gap-2">
                                          ...
                                          <button
                                            ...
                                            className="px-4 py-2 bg-red-600 text-white text-sm rounded-lg hover:bg-red-700 transition-all duration-200"
                                          >
                                            Cancel
                                          </button>
                                        </div>
                                      ...
                                      <button
                                        ...
                                        className="w-full py-2 px-4 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white text-sm rounded-lg hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5 font-medium"
                                      >
                                        Add Subtask
                                      </button>
                                    )}
