...
const initialTasks = [
  ...
  },
  {
    ...
    timeline: [null, null],
    planDays: 15,
    remarks: "Modern office complex with smart features",
    assigneeNotes: "Foundation work completed",
    attachments: [],
    priority: "High",
  ...
  },
  {
    ...
    timeline: [null, null],
    planDays: 20,
    remarks: "Luxury residential tower",
    assigneeNotes: "Planning phase",
    attachments: [],
    priority: "Medium",
  ...
  },
  {
    ...
    timeline: [null, null],
    planDays: 18,
    remarks: "Modern shopping mall with entertainment",
    assigneeNotes: "Structural work in progress",
    attachments: [],
    priority: "High",
  ...
  },
  {
    ...
    timeline: [null, null],
    planDays: 12,
    remarks: "Large-scale industrial warehouse",
    assigneeNotes: "Project completed successfully",
    attachments: [],
    priority: "Medium",
  ...
  },
  {
    ...
    timeline: [null, null],
    planDays: 25,
    remarks: "5-star luxury hotel complex",
    assigneeNotes: "Interior work in progress",
    attachments: [],
    priority: "High",
  ...
  },
  {
    ...
    timeline: [null, null],
    planDays: 30,
    remarks: "Modern educational campus",
    assigneeNotes: "Design phase",
    attachments: [],
    priority: "Medium",
  ...
  },
  {
    ...
    timeline: [null, null],
    planDays: 22,
    remarks: "State-of-the-art medical center",
    assigneeNotes: "Equipment installation",
    attachments: [],
    priority: "High",
  ...
  },
  {
    ...
    timeline: [null, null],
    planDays: 16,
    remarks: "Multi-sport complex",
    assigneeNotes: "Funding issues",
    attachments: [],
    priority: "Low",
  ...
  },
  {
    ...
    timeline: [null, null],
    planDays: 28,
    remarks: "Innovation hub for tech companies",
    assigneeNotes: "Infrastructure setup",
    attachments: [],
    priority: "High",
...
export default function MainTable() {
  ...
  return (
    <div className="flex bg-gradient-to-br from-gray-50 via-white to-blue-50 h-full overflow-hidden">
      {/* Sidebar */}
          ...
          <div className="flex-1 flex flex-col mt-4 min-h-0 overflow-hidden">
            <div className="w-full px-4 py-0 bg-white rounded-xl shadow-lg border border-gray-200 overflow-auto">
              <div className="min-w-full">
                <table className="w-full table-auto bg-white" style={{ minWidth: '2000px' }}>
                    ...
                    <SortableContext items={columnOrder} strategy={horizontalListSortingStrategy}>
                      <thead className="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200 sticky top-0 z-10">
                        <tr>
                          ...
                          <th key="add-column" className="px-3 py-4 text-center bg-gradient-to-r from-gray-50 to-gray-100">
                            <button
