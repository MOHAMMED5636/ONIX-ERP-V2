    ...
    <div className="p-6">
      ...
      <div className="bg-white/80 backdrop-blur-sm shadow-sm rounded-lg border border-gray-200 mb-6">
        <div className="flex items-center justify-between px-6 py-4">
          {/* Left side - Document Management Indicator */}
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Construction documents and templates</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <input
                type="text"
                placeholder="Search documents... (Ctrl+K to focus)"
