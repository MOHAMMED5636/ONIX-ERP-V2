          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="bg-white bg-opacity-10 rounded-2xl p-4 backdrop-blur-sm">
                <div className="text-white text-2xl font-bold">{filteredSubDepartments.length}</div>
                <div className="text-green-100 text-sm">
                  {searchTerm ? 'Filtered Sub Departments' : 'Total Sub Departments'}
                </div>
              </div>
              <div className="bg-white bg-opacity-10 rounded-2xl p-4 backdrop-blur-sm">
                <div className="text-white text-2xl font-bold">{filteredSubDepartments.reduce((sum, subDept) => sum + subDept.employees, 0)}</div>
                <div className="text-green-100 text-sm">Total Employees</div>
              </div>
              <div className="bg-white bg-opacity-10 rounded-2xl p-4 backdrop-blur-sm">
                <div className="text-white text-2xl font-bold">{filteredSubDepartments.filter(subDept => subDept.status === 'Active').length}</div>
                <div className="text-green-100 text-sm">
